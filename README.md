...
I build and ship production software. I design REST APIs in **FastAPI**, model relational data in **PostgreSQL**, build interfaces in **React**, and deploy on **AWS** with **Docker** and CI/CD pipelines.
